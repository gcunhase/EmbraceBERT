...
stt_error, dataname, model, epoch, epoch_q, bs, tts_stt_type = [False, "chatbot", "embracebertwithkeyvaluequery_projection_p_attention_clsquery_weights", 100, 3, 8, 'gtts_google']  # _withDropout0.1
