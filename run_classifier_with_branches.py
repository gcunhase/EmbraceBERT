...
from models.EmbraceBERT_with_branches import EmbraceBertWithBranchesForSequenceClassification
...
MODEL_CLASSES = {
    ...
    'embracebert_with_branches': (BertConfig, EmbraceBertWithBranchesForSequenceClassification, BertTokenizer),
    ...
    for _ in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs = {'input_ids':      batch[0],
                      ...
                      'token_type_ids': batch[2] if args.model_type in ['embracebert', 'embracebert_with_branches', 'bert', 'xlnet'] else None,  # XLM and RoBERTa don't use segment_ids
                      'labels':         batch[3]}
            if args.model_type in ['embracebert', 'embraceroberta', 'bert', 'roberta', 'embracebert_with_branches']:
...
def evaluate(args, model, tokenizer, prefix=""):
    ...
    for eval_task, eval_output_dir in zip(eval_task_names, eval_outputs_dirs):
        ...
        for batch in tqdm(eval_dataloader, desc="Evaluating"):
            ...
            nb_eval_steps += 1
            if preds is None:
                if args.model_type in ['embracebert', 'embracebert_with_branches']:
...
def main():
    ...
    if args.model_type in ['embracebert_with_branches']:
