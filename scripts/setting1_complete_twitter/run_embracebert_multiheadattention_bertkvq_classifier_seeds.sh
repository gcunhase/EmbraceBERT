...
if [[ $LANGUAGE == *"english"* ]]; then
  ...
  OUTPUT_DIR="../../results_twitter/${MODEL_TYPE}_${DIM_REDUCTION_METHOD}_p_${P_TYPE}/"
  RUN_DIR="../../runs_twitter/${MODEL_TYPE}_${DIM_REDUCTION_METHOD}_p_${P_TYPE}/"
  DATA_PATH_NAME="twitter_sentiment_data"
else
  MODEL_NAME_OR_PATH="bert-base-multilingual-uncased"
  OUTPUT_DIR="../../results_twitter_korean/${MODEL_TYPE}_${DIM_REDUCTION_METHOD}_p_${P_TYPE}/"
  RUN_DIR="../../runs_twitter_korean/${MODEL_TYPE}_${DIM_REDUCTION_METHOD}_p_${P_TYPE}/"
