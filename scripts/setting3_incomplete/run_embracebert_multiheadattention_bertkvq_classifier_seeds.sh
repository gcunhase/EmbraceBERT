  ...
  for DATASET in snips; do # chatbot; do
      ...
      for EPOCH in 100; do
          ...
          for STT in "macsay"; do # "gtts" "macsay"; do
            for TTS in "sphinx"; do # "google" "sphinx" "witai"; do
              STT_TTS="${STT}_${TTS}"
            ...
            for TTS in "witai"; do # "google" "sphinx" "witai"; do
              STT_TTS="${STT}_${TTS}"
              DATA_DIR="../../data/${DATA_PATH_NAME}/${DATASET}/${STT_TTS}/"
