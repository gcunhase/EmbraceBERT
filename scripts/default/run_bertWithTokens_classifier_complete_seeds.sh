...
MODEL_TYPE=bertwithattprojection  #bertwithatt  #bertwithprojection
...
MODEL_TYPE=bertwithprojectionatt  #bertwithatt  #bertwithprojection
OUTPUT_DIR="../../results/${MODEL_TYPE}/"
RUN_DIR="../../runs/${MODEL_TYPE}/"
...
MODEL_TYPE=bertwithprojection  #bertwithatt  #bertwithprojection
OUTPUT_DIR="../../results/${MODEL_TYPE}/"
RUN_DIR="../../runs/${MODEL_TYPE}/"
