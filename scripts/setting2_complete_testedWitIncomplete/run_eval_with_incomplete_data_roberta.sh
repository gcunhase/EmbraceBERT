...
MODEL_TYPE=robertawithatt  # Options = [roberta, robertawithatt, robertawithprojection, robertawithprojectionatt, robertawithattclsprojection]
...
MODEL_TYPE=robertawithprojection  # Options = [roberta, robertawithatt, robertawithprojection, robertawithprojectionatt, robertawithattclsprojection]
MODEL_NAME="${MODEL_TYPE}"
...
MODEL_TYPE=robertawithprojectionatt  # Options = [roberta, robertawithatt, robertawithprojection, robertawithprojectionatt, robertawithattclsprojection]
MODEL_NAME="${MODEL_TYPE}"
...
MODEL_TYPE=robertawithattclsprojection  # Options = [roberta, robertawithatt, robertawithprojection, robertawithprojectionatt, robertawithattclsprojection]
MODEL_NAME="${MODEL_TYPE}"
