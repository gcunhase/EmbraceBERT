...
if root_name == './':
    root_name += 'results/test_with_complete_results/'
                    ...
                    for model_type in [MODEL_BERT]:
                        for bs in bs_array:
                            ...
                            for model in model_type:
                                ...
                                prefix = "stterror_{}".format(noise_perc)
                                root_dir = '{root_name}{model}/{dataname}/{prefix}/{tts_stt_type}/{dataname}_ep{epoch}_bs{bs}_'. \
                                    format(root_name=root_name, model=model, dataname=dataname, prefix=prefix,
                                           epoch=epoch, bs=bs, tts_stt_type=tts_stt_type)
